<?php 
	...
	if(isset($_POST['update'])){
		...
		if($sql_udpate){
			...
			move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"../bahana_images_assets/ads_slot_assets/".$idget.".gif");
	...
	if(isset($_POST['simpan'])){
		...
		// $file_upload = move_uploaded_file($file, "../bahana_images_assets/epa/12.gif");

		if($sql_simpan){

			move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"../bahana_images_assets/ads_slot_assets/".$data_gambar.".gif");
	...
	if(isset($_GET['delete'])){
		...
		if($sql_delete){
			        $filePath = "../../bahana_images_assets/ads_slot_assets/".$_GET['delete'].".gif";
		...
		<form method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<select name="category" class="form-control"> 
					<option value="HOME_TOP">1.HOME_TOP</option>
					<option value="INPAGE_ADS">2.INPAGE_ADS</option>
					<option value="SEC_ADS">3.SEC_ADS</option>
					<option value="LEFT">4.LEFT</option>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $data['date']; ?></td>
						...
						<?php
                    $filename = "../bahana_images_assets/ads_slot_assets/".$data['id'].".gif";
                            if (!file_exists($filename)) {
                                

                ?>

                <td><a target="blank" href="../bahana_images_assets/ads_slot_assets/if_foto_kosong.gif"><img style="height: 50px; width:50px;" src="../bahana_images_assets/epa/if_foto_kosong.gif"></a></td>
                <td>
                    ...
                    <?php
                                ...
                                ?>
                <td><a target="blank" href="../bahana_images_assets/ads_slot_assets/<?php echo $data['id'];?>.gif"><img style="height: 50px; width:50px;" src="../bahana_images_assets/ads_slot_assets/<?php echo $data['id'];?>.gif"></a></td>
