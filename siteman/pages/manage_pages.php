...
<body>
    ...
    <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"  id="datanya" > 
        ...
        <h1 style="margin-top: 0px; font-weight: bold; margin-left: -2%; margin-bottom: 5%;">MANAGE PAGES</h1>
        </div>
    ...
    <table id="example" class="display" cellspacing="0" width="100%">
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                <a target="_blank" href="https://joker.5dapps.com/masimanetwork/bahanafm/pages/index.php?details=<?php echo $row['idPages']?>"><i class="fa fa-search"></i>&nbsp;</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
