...
if(isset($_GET['delete'])){
    ...
    if($sqldelete){
                $filePath = "../../bahana_images_assets/wadyabala_assets/".$_GET['delete'].".jpg";
    ...
    // $data_customer = mysql_fetch_array(mysql_query("SELECT * FROM tb_customer WHERE id_customer = '$row[id_customer]'"));
        ...
        ?>
        	...
        	<tr>
                ...
                <?php
                    $filename = "../bahana_images_assets/wadyabala_assets/".$row['ID'].".jpg";
                            if (!file_exists($filename)) {
                                

                ?>

                <td><a target="blank" href="../bahana_images_assets/wadyabala_assets/if_foto_kosong.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/wadyabala_assets/if_foto_kosong.jpg"></a></td>
                <td>
                    ...
                    <?php
                                ...
                                ?>
                <td><a target="blank" href="../bahana_images_assets/wadyabala_assets/<?php echo $row['ID'];?>.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/wadyabala_assets/<?php echo $row['ID'];?>.jpg"></a></td>
                <td>
      ...
      <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="formnya" style="display: none;">
            ...
            <center><h2>FORM Input Broadcaster</h2></center>
                ...
                <div>  
            <form enctype="multipart/form-data" class="form-group"  method="post" action="process/add_wadyalaba.php">
                <!-- <input  name="id_hadiah" value="<?php echo $Data[0]?>"> -->
                    ...
                    <br>
                    <label>Link</label>
                     <input class="form-control md-6" type="text" name="link" placeholder="Link"  required="" value="<?php echo $Data['link']?>">
                    <br>
                    <br>
