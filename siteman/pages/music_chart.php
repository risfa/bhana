...
if(isset($_GET['delete'])){
    ...
    if($sqldelete){
        $filePath = "../../bahana_images_assets/chart_assets/".$_GET['delete'].".jpg";
...
<br><br>
    ...
    // $data_customer = mysql_fetch_array(mysql_query("SELECT * FROM tb_customer WHERE id_customer = '$row[id_customer]'"));
        ...
        ?>
        	...
        	<tr>
                <td><?php echo $no ;?></td>
                <td><?php echo $row['song_tittle'];?></td>
...
<!--         		<td><a target="blank" href="../bahana_images_assets/chart_assets/<?php echo $row['id'];?>.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/chart_assets/<?php echo $row['id'];?>.jpg"></a></td>
        		<td>
 ...
 -->
            ...
            <?php
                    $filename = "../bahana_images_assets/chart_assets/".$row['id'].".jpg";
                            if (!file_exists($filename)) {
                                  

                ?>

                <td><a target="blank" href="../bahana_images_assets/chart_assets/if_foto_kosong.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/chart_assets/if_foto_kosong.jpg"></a></td>
                <td>
