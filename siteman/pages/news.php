...
if(isset($_GET['delete'])){
    ...
    if($sqldelete){
       ...
       $filePath = "../../bahana_images_assets/news/".$id_foto.".jpg";
...
<br><br>
    ...
    // $data_customer = mysql_fetch_array(mysql_query("SELECT * FROM tb_customer WHERE id_customer = '$row[id_customer]'"));
        ...
        <!-- 		<td><a target="blank" href="../bahana_images_assets/news/<?php echo $row['ID'];?>.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/news/<?php echo $row['ID'];?>.jpg"></a></td>
                ...
                <?php
                    $filename = "../bahana_images_assets/news/".$row['ID'].".jpg";
                            if (!file_exists($filename)) {
                                

                ?>

                <td><a target="blank" href="../bahana_images_assets/news/if_foto_kosong.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/news/if_foto_kosong.jpg"></a></td>
                <td>
                ...
                <td>
                    ...
                    ?>
                        ...
                        <td><a target="_blank" href="https://joker.5dapps.com/masimanetwork/bahana/pages/news_details.php?details=<?php echo $row['ID']?>"><i class="fa fa-search"></i>&nbsp;</a></td>
