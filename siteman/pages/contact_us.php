...
<body>
  ...
  <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
        <h1 style="margin-top: 0px; font-weight: bold; margin-left: 2%;">CONTACT US</h1>
      </div>
...
<br><br>
    <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <?php
        $tampil = mysql_query("SELECT * FROM ContactUs");
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                <a target="_blank" href="https://joker.5dapps.com/masimanetwork/bahana/pages/index.php?details=<?php echo $row['idPages']?>"><i class="fa fa-search"></i>&nbsp;</a>
                </td> -->
            </tr>
        <?php } ?>
        </tbody>
    ...
    $.getJSON('//freegeoip.net/json/?callback=?', function(data) {
      ...
      // console.log(test.ip);
      var url = "https://joker.5dapps.com/masimanetwork/bahana/siteman/api.php"
