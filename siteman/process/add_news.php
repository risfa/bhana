...
session_start();
	...
	if(isset($_POST['simpan'])){
		...
		// upload
			$target_dir = "../../bahana_images_assets/news/";
	...
	if(isset($_POST['update'])){
		...
		$sqlupdate = mysql_query("UPDATE news SET post_date='$date_update', post_content='$post_content_update', post_title='$post_tittle_update', category='$category' WHERE ID = '$ID'");
		if($sqlupdate){
			move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"../../bahana_images_assets/news/".$ID.".jpg");
