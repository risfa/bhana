...
<body class="har_middle_titles">
  ...
  <div class="har_page" id="har_page">
    ...
    <div class="har_page_title har_page_title_great har_image_bck har_fixed har_wht_txt" data-stellar-background-ratio="0.2" data-color="#333">
      ...
      <!-- Over -->
      <div class="har_over" style="  background: linear-gradient(to right, rgba(255,152,41,1) 0%, rgba(253,187,21,1) 86%, rgba(250,201,5,1) 100%) !important;"></div>

      <div class="container text-left">
        <div class="row">
          <?php
          $data_news_1 = mysql_fetch_array(mysql_query("SELECT * FROM news  WHERE ID = '$_GET[details]'"));
          ?>

          <div class="col-md-8" style="color:black;">
            <h1 class="har_h1_title" ><?php echo $data_news_1[4]?></h1>
            <h3></h3>
          </div>
    ...
    <section id="har_content" class="har_content">
      ...
      <section class="har_section" style="padding-top: 40px;">
        <div class="container">
            ...
            <div class="col-md-2  hidden-xs hidden-sm" style="background:orange;">
            ...
            <div class="col-md-10 col-xs-12">
              ...
              <div class="har_post_item" style=" font-size: 17px;">
                ...
                <div class="har_post_title">
                  <h3><a id="image-content" href="#"><?php echo          $data_news_1[4]?></a></h3>
                </div>
                ...
                <p style="font-size:15px;"><?php echo $data_news_1[3]?></p>

              </div>
              <?php
                            $id=$_GET['details'];
                            $currentid = $id;
                            $prevquery= "SELECT * FROM news WHERE ID < $currentid ORDER BY ID DESC LIMIT 1";
                            $dataprev = mysql_fetch_array(mysql_query($prevquery));
                            $prevresult = mysql_query($prevquery);
                            $prevcount = mysql_num_rows($prevresult);

                            $nextquery = "SELECT * FROM news WHERE ID > $currentid ORDER BY ID ASC LIMIT 1";
              ...
              <div class="col-md-4 hidden-xs hidden-sm" style="text-align: center;">
                <a href="news_details.php?details=<?php echo $dataprev[0] ?>" class="btn"> < PREVIOUS </a>
              </div>
              <?php } ?>
              <div class="col-md-4 hidden-xs hidden-sm" style="text-align: center;">
              ...
              <?php if($nextcount>0){ ?>
              <div class="col-md-4 hidden-xs hidden-sm" style="text-align: center">
                <a href="news_details.php?details=<?php echo $datanext[0] ?>" class="btn">NEXT</a>
              </div>
              <?php } ?>
